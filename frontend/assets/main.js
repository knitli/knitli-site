...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-3', { style: 'fade-down', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-4', { style: 'fade-in', speed: 750, intensity: 2, threshold: 3, delay: 0, stagger: 750, staggerSelector: ':scope > *', replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-left', speed: 500, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.form-component.style-2', { style: 'zoom-out', speed: 500, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.icons-component.style-2', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 125, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-16', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-10', { style: 'fade-left', speed: 500, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.buttons-component.style-2', { style: 'fade-down', speed: 500, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-11', { style: 'fade-down', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-12', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-13', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-22', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-5', { style: 'fade-in', speed: 875, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.icons-component.style-4', { style: 'fade-down', speed: 500, intensity: 0, threshold: 3, delay: 875, replay: false });
		onvisible.add('.text-component.style-20', { style: 'fade-in', speed: 875, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-19', { style: 'fade-down', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-6', { style: 'fade-down', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-1', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-21', { style: 'fade-in', speed: 875, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-15', { style: 'fade-in', speed: 875, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'fade-down', speed: 500, intensity: 0, threshold: 3, delay: 125, replay: false });
		onvisible.add('.image-component.style-1', { style: 'zoom-in-image', speed: 500, intensity: 5, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-8', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-17', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.text-component.style-18', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 125, replay: false });
